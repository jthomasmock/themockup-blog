...
Over the past month or so, the [r4ds online learning community](https://www.jessemaegan.com/blog/r4ds-the-next-iteration/) founded by [Jesse Maegan](https://www.jessemaegan.com/) has been developing projects intended to help connect mentors and learners. One of the first projects born out of this collaboration is [#TidyTuesday](https://github.com/rfordatascience/tidytuesday), a weekly social data project focused on using `tidyverse` packages to clean, wrangle, tidy, and plot a new dataset every Tuesday.

If you are interested in joining the r4ds online learning community check out Jesse Maegan's post [here](https://www.jessemaegan.com/blog/r4ds-the-next-iteration/)!
...
[The R4DS Online Learning Community](https://www.jessemaegan.com/blog/r4ds-the-next-iteration/)
