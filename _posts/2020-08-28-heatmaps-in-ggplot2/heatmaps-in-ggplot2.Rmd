...
This is requires us to play around a bit more with matrices, which is a good exercise! I'm going to keep working to see if this could fit into a `tibble` oriented workflow, but so far it's a matrix up to the end.
