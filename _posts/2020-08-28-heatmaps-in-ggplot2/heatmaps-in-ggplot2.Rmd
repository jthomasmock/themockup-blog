...
We can add 90% transparency with `alpha = 0.1` or set `alpha` as a ratio, and change the color to red, but this still leaves us with difficulty parsing through the high vs medium pass locations. Although the 1/20 ratio gets us a bit farther. The ratio denominator can be though of as the "number of points that must overplotted to give a solid color." ^[https://ggplot2-book.org/statistical-summaries.html#overplotting]
