...
data_in <- tibble::tribble(
  ...
  "Beautiful tables with gt and gtExtras", "https://thomasmock.quarto.pub/gtextras-overview/#/", "Presentation", "A broad overview of {gtExtras}",
  "Quarto for the Curious", "https://thomasmock.quarto.pub/quarto-curious/", "Presentation", "A 20 min intro to Quarto",
  "Reproducible Publications with Python and Quarto", "https://thomasmock.quarto.pub/python/", "Presentation", "A 30 min intro to Quarto in Python"
) %>% 
